...
function pkcs1pad2(t, r) {
    ...
    for (var i = new Array, n = t.length - 1; n >= 0 && r > 0;) {
        ...
        o < 128 ? i[--r] = o : o > 127 && o < 2048 ? (i[--r] = 63 & o | 128, i[--r] = o >> 6 | 192) : (i[--r] = 63 & o | 128, i[--r] = o >> 6 & 63 | 128, i[--r] = o >> 12 | 224)
    }
    i[--r] = 0;
...
function am2(t, r, i, n, o, e) {
    for (var s = 32767 & r, h = r >> 15; --e >= 0;) {
        var p = 32767 & this[t],
            g = this[t++] >> 15,
            u = h * p + g * s;
        p = s * p + ((32767 & u) << 15) + i[n] + (1073741823 & o), o = (p >>> 30) + (u >>> 15) + h * g + (o >>> 30), i[n++] = 1073741823 & p
    }
    return o
}
function am3(t, r, i, n, o, e) {
    for (var s = 16383 & r, h = r >> 14; --e >= 0;) {
        var p = 16383 & this[t],
            g = this[t++] >> 14,
            u = h * p + g * s;
        p = s * p + ((16383 & u) << 14) + i[n] + o, o = (p >> 28) + (u >> 14) + h * g, i[n++] = 268435455 & p
    }
    return o
}
function int2char(t) {
...
function bnpFromString(t, r) {
    ...
    8 == i && 0 != (128 & t[0]) && (this.s = -1, e > 0 && (this[this.t - 1] |= (1 << this.DB - e) - 1 << e)), this.clamp(), o && BigInteger.ZERO.subTo(this, this)
}
function bnpClamp() {
...
function bnToString(t) {
    ...
    if (s-- > 0)
        for (h < this.DB && (i = this[s] >> h) > 0 && (o = !0, e = int2char(i)); s >= 0;)
            h < r ? (i = (this[s] & (1 << h) - 1) << r - h, i |= this[--s] >> (h += this.DB - r)) : (i = this[s] >> (h -= r) & n, h <= 0 && (h += this.DB, --s)), i > 0 && (o = !0), o && (e += int2char(i));
    return o ? e : "0"
}
function bnNegate() {
    var t = nbi();
...
function bnpRShiftTo(t, r) {
    ...
    n > 0 && (r[this.t - i - 1] |= (this.s & e) << o), r.t = this.t - i, r.clamp()
}
...
function bnpDivRemTo(t, r, i) {
    ...
    if (!(n.t <= 0)) {
        ...
        p > 0 ? (n.lShiftTo(p, e), o.lShiftTo(p, i)) : (n.copyTo(e), o.copyTo(i));
        var g = e.t,
            u = e[g - 1];
        if (0 != u) {
            var a = u * (1 << this.F1) + (g > 1 ? e[g - 2] >> this.F2 : 0),
                ...
                m = v - g,
                b = null == r ? nbi() : r;
            for (e.dlShiftTo(m, b), i.compareTo(b) >= 0 && (i[i.t++] = 1, i.subTo(b, i)), BigInteger.ONE.dlShiftTo(g, b), b.subTo(e, e); e.t < g;)
                e[e.t++] = 0;
            for (; --m >= 0;) {
                var y = i[--v] == u ? this.DM : Math.floor(i[v] * f + (i[v - 1] + c) * l);
                if ((i[v] += e.am(0, y, i, m, 0, g)) < y)
                    for (e.dlShiftTo(m, b), i.subTo(b, i); i[v] < --y;)
                        i.subTo(b, i)
            }
            null != r && (i.drShiftTo(g, r), s != h && BigInteger.ZERO.subTo(r, r)), i.t = g, i.clamp(), p > 0 && i.rShiftTo(p, i), s < 0 && BigInteger.ZERO.subTo(i, i)
        }
    }
}
function bnMod(t) {
...
function montReduce(t) {
    ...
    for (var r = 0; r < this.m.t; ++r) {
        ...
        for (i = r + this.m.t, t[i] += this.m.am(0, n, t, r, 0, this.m.t); t[i] >= t.DV;)
            t[i] -= t.DV, t[++i]++
    }
...
function ARC4init(t) {
    ...
    for (r = 0; r < 256; ++r)
        this.S[r] = r;
    for (i = 0, r = 0; r < 256; ++r)
        i = i + this.S[r] + t[r % t.length] & 255, n = this.S[r], this.S[r] = this.S[i], this.S[i] = n;
    this.i = 0, this.j = 0
}
function ARC4next() {
    var t;
